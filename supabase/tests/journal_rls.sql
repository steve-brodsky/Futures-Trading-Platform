...
select policies_are('public','journal_trades',array['journal trades owner insert','journal trades owner read','journal trades owner update'],'trade snapshots expose owner-scoped policies');
select * from finish();
rollback;
